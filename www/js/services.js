angular.module('ingredientApp.services', [])
...
console.log(WORDPRESS_API_URL + 'get_recent_posts/' +
      '?page='+ page +
    ...
    .success(function(data) {
	  ...
	  console.log('Succes to get data from server');
    })
    .error(function(data) {
	  console.log('--------------------------------------Error to get data from server: '+ data.toSource());
